...
#include "main.h"
#include "radio_config_Si44637.h"

#define PACKET_LENGTH 0 //0-64, 0:动态长度 1:固定长度

/** SI4463硬件接口IO定义 */
#define SI4463_CLK_PORT GPIOB
#define SI4463_CLK_CLKEN() __HAL_RCC_GPIOA_CLK_ENABLE()
#define SI4463_CLK_PIN GPIO_PIN_7

#define SI4463_MISO_PORT GPIOB
#define SI4463_MISO_CLKEN() __HAL_RCC_GPIOA_CLK_ENABLE()
#define SI4463_MISO_PIN GPIO_PIN_6

#define SI4463_MOSI_PORT GPIOB
#define SI4463_MOSI_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_MOSI_PIN GPIO_PIN_10

#define SI4463_NSS_PORT GPIOB
#define SI4463_NSS_CLKEN() __HAL_RCC_GPIOA_CLK_ENABLE()
#define SI4463_NSS_PIN GPIO_PIN_14

#define SI4463_SDN_PORT GPIOB
#define SI4463_SDN_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_SDN_PIN GPIO_PIN_3

#define SI4463_IRQ_PORT GPIOB
#define SI4463_IRQ_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_IRQ_PIN GPIO_PIN_8

#define SI4463_GPIO0_PORT GPIOB
#define SI4463_GPIO0_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_GPIO0_PIN GPIO_PIN_11

#define SI4463_GPIO1_PORT GPIOB
#define SI4463_GPIO1_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_GPIO1_PIN GPIO_PIN_1

#define SI4463_GPIO2_PORT GPIOB
#define SI4463_GPIO2_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_GPIO2_PIN GPIO_PIN_12

#define SI4463_GPIO3_PORT GPIOB
#define SI4463_GPIO3_CLKEN() __HAL_RCC_GPIOB_CLK_ENABLE()
#define SI4463_GPIO3_PIN GPIO_PIN_13
