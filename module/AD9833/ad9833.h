...
#define AD9833_FSYNC(x) HAL_GPIO_WritePin(GPIOE,GPIO_PIN_2,x)
#define AD9833_CLK(x) HAL_GPIO_WritePin(GPIOE,GPIO_PIN_3,x)
#define AD9833_DA(x) HAL_GPIO_WritePin(GPIOE,GPIO_PIN_0,x)
